...
public class B3_Activity1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String sUsername = getIntent().getStringExtra(B3_Activity2.KEY_USERNAME);
        String sPassword = getIntent().getStringExtra(B3_Activity2.KEY_PASSWORD);
        ...
        btnRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), B3_Activity2.class);
